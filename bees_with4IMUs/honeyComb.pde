...
//    private final float x, y, radius;
//    private final float z;
//    private ArrayList<Bee> restingBees;
...
//        this.radius = radius;
//        this.z = random(-10, 10); // Random z value for slight 3D effect
//        this.restingBees = new ArrayList<Bee>();
//        addBees();
//    }

//    private void addBees() {
//        int numBees = 5; // Add exactly 5 bees
//        for (int i = 0; i < numBees; i++) {
//            float angle = TWO_PI / numBees * i;
//            float offsetX = cos(angle) * radius * 0.5;
//            float offsetY = sin(angle) * radius * 0.5;
//            restingBees.add(new Bee(x + offsetX, y + offsetY));
//        }
//    }
